...
<script>
    ...
    // What we can do with e. ==> type, timestamp, defaultPrevented, target, toElement, srcElement, currentTarget
    // for interview ==> clientX, clientY, screenX, screenY
...
```html
<!-- Small exercise to remove the images when we click on that -->
